...
package aetherv1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1 "github.com/SingularityCoLabs/aether/gen/go/aether/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SystemServiceName = "aether.v1.SystemService"
)
...
const (
	...
	// GetSystemInfo RPC.
	SystemServiceGetSystemInfoProcedure = "/aether.v1.SystemService/GetSystemInfo"
)

// SystemServiceClient is a client for the aether.v1.SystemService service.
...
// NewSystemServiceClient constructs a client for the aether.v1.SystemService service. By default,
...
func NewSystemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SystemServiceClient {
	...
	systemServiceMethods := v1.File_aether_v1_system_proto.Services().ByName("SystemService").Methods()
...
// GetSystemInfo calls aether.v1.SystemService.GetSystemInfo.
...
// SystemServiceHandler is an implementation of the aether.v1.SystemService service.
...
func NewSystemServiceHandler(svc SystemServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/aether.v1.SystemService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSystemServiceHandler) GetSystemInfo(context.Context, *connect.Request[v1.GetSystemInfoRequest]) (*connect.Response[v1.GetSystemInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aether.v1.SystemService.GetSystemInfo is not implemented"))
}
